...
{
  if(order) {
  //number string, x position, y position
    myScreen.drawNumBig((String)1234, 0, 0);
    myScreen.drawNumBig((String)5678, 0, 75);
    myScreen.drawNumBig((String)90, 0, 150);
  }
  else {
    // myScreen.drawNumBig((String)0987, 0, 0);
    myScreen.drawNumBig((String)6543, 0, 75);
    myScreen.drawNumBig((String)21, 0, 150);
  }
  myScreen.flush(); //fast update screen
  order = !order;
  delay(1000);
}
